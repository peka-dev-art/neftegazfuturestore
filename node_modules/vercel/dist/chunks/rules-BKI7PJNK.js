...
async function rules(client, argv) {
  if (argv.length === 0 || argv[0]?.startsWith("-")) {
    const lsFn = (await import("./ls-MS3FACFC.js")).default;
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-MS3FACFC.js")).default(client, args);
    case "schema":
      return (await import("./schema-ZNPIMQL5.js")).default(client, args);
    case "add":
      return (await import("./add-JLCJCRV6.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-HPZSCLO4.js")).default(client, args);
    case "rm":
      return (await import("./rm-ZAXW6GEF.js")).default(client, args);
    case "update":
      return (await import("./update-4SJXDMTG.js")).default(client, args);
    default:
