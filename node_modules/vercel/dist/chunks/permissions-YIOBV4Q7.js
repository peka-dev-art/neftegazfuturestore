...
async function permissions(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-642SJJPI.js")).default(client, argv, telemetry);
    case "add":
      return (await import("./add-CJZGLI73.js")).default(client, argv, telemetry);
    case "rm":
      return (await import("./rm-W7LO4WXB.js")).default(client, argv, telemetry);
    case "clear":
      return (await import("./clear-C2MXHYPE.js")).default(client, argv, telemetry);
    default:
