...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-FKFZKWHH.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-YRRS3ZXR.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-HSUWESWO.js")).default(client, args, telemetry);
    default:
